...
gnome-terminal --working-directory=${bsn}/configurations/environment   -e 'roslaunch --pid=/var/tmp/patient_'$2'.pid patient_'$2'.launch' & sleep 5s
...
kill $(cat /var/tmp/patient_$2.pid && rm /var/tmp/patient_$2.pid) & sleep 1s
