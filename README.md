...
*(Skip this step if you want to use the [provided t-way combinations](https://anonymous.4open.science/r/PASTA_SAFECOMP-5F11/PASTA/Output_Files/1_ACTS_BSN_Test_Set_t2/1_ACTS_BSN_Test_Set_t_2.txt))*
...
3. Click on *System->Open...* and choose the file `PASTA_SAFECOMP-5F11/PASTA/Output_Files/1_ACTS_BSN_Test_Set_t2/1_ACTS_BSN_Test_Set_t_2.txt` previously downloaded on your computer.
...
#### **Outcome Files**:
- [1 - ACTS Test Set](https://anonymous.4open.science/r/PASTA_SAFECOMP-5F11/PASTA/Output_Files/1_ACTS_BSN_Test_Set_t2/1_ACTS_BSN_Test_Set_t_2.txt) (Configuration of the ACTS tool and the output (t-way combinations))
- [2 - Test Patients](https://anonymous.4open.science/r/PASTA_SAFECOMP-5F11/PASTA/Output_Files/2_Test_Patients/) (Patient Configuration Files for the BSN)
- [3 - BSN Logs ](https://anonymous.4open.science/r/PASTA_SAFECOMP-5F11/PASTA/Output_Files/3_BSN_Logs/) (Log files generated by the SA-BSN)
- [4 - Sensor Readings, BSN Outcomes and Expected Outcomes](https://anonymous.4open.science/r/PASTA_SAFECOMP-5F11/PASTA/Output_Files/4_Sensor_Readings_BSN_Outcome_and_Expected_Outcome/) (Parsing of BSN Logs)
- [5 - Summary of Results](https://anonymous.4open.science/r/PASTA_SAFECOMP-5F11/PASTA/Output_Files/5_Summary_Of_Results/Pasta_experiments.ods) (Testing Results)
...
### **Outcome Files**:
- [1 - Test Patient](https://anonymous.4open.science/r/PASTA_SAFECOMP-5F11/Random_Approach/Output_Files/1_Test_Patients/patient_0.launch) (Patient Configuration File for the BSN)
- [2 - BSN Logs ](https://anonymous.4open.science/r/PASTA_SAFECOMP-5F11/Random_Approach/Output_Files/2_BSN_Logs/) (Log files generated by the SA-BSN)
- [3 - Sensor Readings, BSN Outcomes and Expected Outcomes](https://anonymous.4open.science/r/PASTA_SAFECOMP-5F11/Random_Approach/Output_Files/3_Sensor_Readings_BSN_Outcome_and_Expected_Outcome/ParseLog.tar.xz) (Parsing of BSN Logs)
- [4 - Summary of Results](https://anonymous.4open.science/r/PASTA_SAFECOMP-5F11/Random_Approach/Output_Files/4_Summary_Of_Results/)(Testing Results)

## **Statistical Tests**
- [1 - Datasets](https://anonymous.4open.science/r/PASTA_SAFECOMP-5F11/Scripts_Statistical_Tests/dataset.tar.xz) (Dataset with Test Cases (Sensor Readings and Expected Outcomes) and BSN Outcomes)
- [2 - Script ](https://anonymous.4open.science/r/PASTA_SAFECOMP-5F11/Scripts_Statistical_Tests/statistical_analysis.R) (Script to compute statistical tests)
